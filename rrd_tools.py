...
class RRDTools:
	...
	def createRRD( self, hostname: str ):
	...
	def updateRRD( self, hostname: str, tiempo_inicial: int, tiempo_final: int ):
	...
	def graphRRD( self, hostname: str, tiempo_inicial: int, tiempo_final: int ):
